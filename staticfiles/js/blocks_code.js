  ...
  alert("kuch b")
  var code="var a=document.getElementById('svgMaze').contentDocument; document.getElementById('pegman').style.transform=translate(295px, 115px);"
